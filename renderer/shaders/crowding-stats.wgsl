...
struct Config {
    ...
    fovea_aspect_ratio: f32, // elliptical fovea shape; value is uploaded by the
                             // host via uploadAndConfigure(). Single source of
                             // truth for the default lives in renderer/config.js
                             // as FOVEA_ASPECT_RATIO_DEFAULT (citation TODO there).
